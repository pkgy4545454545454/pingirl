...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Grâce à PinkGirl, j'ai augmenté ma clientèle de 40% en 3 mois. La publicité IA est incroyablement efficace !",
    videoUrl: null,
    type: "entreprise"
  },
  {
    ...
    rating: 5,
    text: "Le cashback PinkGirl m'a permis d'économiser plus de 500 CHF cette année. Je recommande à tous mes amis !",
    videoUrl: null,
    type: "client"
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    text: "PinkGirl Pro++ a transformé ma relation avec mes clients B2B. Les livraisons récurrentes sont un game-changer.",
    videoUrl: null,
    type: "entreprise"
  },
  {
...
const TestimonialCard = ({ testimonial, isActive }) => {
  ...
  return (
    <div className={`transition-all duration-500 ${
      ...
      <div className="bg-pink-50/50 backdrop-blur-sm rounded-2xl p-6 border border-pink-100 max-w-lg mx-auto">
        {/* Video or Quote */}
    ...
    <section className="py-20 px-4 bg-gradient-to-b from-[#0a0a0f] to-[#111118]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-pink-50 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors"
          >
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-pink-50 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors"
          >
