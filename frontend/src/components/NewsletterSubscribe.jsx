...
const NewsletterSubscribe = ({ variant = 'default' }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="flex gap-2">
          <input
            ...
            required
            className="flex-1 px-4 py-2 bg-pink-50 border border-pink-200 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 text-sm"
          />
          <button
            type="submit"
            disabled={isLoading}
  ...
  return (
    <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-pink-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
        <div className="grid grid-cols-2 gap-3">
          <input
            ...
            className="px-4 py-3 bg-pink-50 border border-pink-200 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
          />
          <input
            type="email"
            value={email}
