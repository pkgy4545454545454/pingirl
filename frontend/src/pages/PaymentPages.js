...
const PaymentSuccessPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-20 flex items-center justify-center px-4" data-testid="payment-success-page">
      ...
      <div className="max-w-lg w-full text-center relative z-10">
        {status === 'loading' && (
          <div className="card-service rounded-2xl p-8 md:p-12 border border-pink-400/30 animate-pulse-border">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-pink-400/20 to-[#D4AF37]/20 flex items-center justify-center mx-auto mb-8">
              <Loader2 className="w-12 h-12 text-pink-500 animate-spin" />
            </div>
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-4" style={{ fontFamily: 'Dancing Script, cursive' }}>
            ...
            <div className="card-service rounded-2xl p-8 md:p-12 border border-green-500/30 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <span className="text-sky-400 text-sm font-medium">Transaction confirmée</span>
                  <Sparkles className="w-5 h-5 text-sky-400" />
                </div>
                ...
                <div className="bg-pink-50/50 rounded-xl p-4 mb-6 text-left">
...
const PaymentCancelPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-20 flex items-center justify-center px-4" data-testid="payment-cancel-page">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
