    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="text-center md:text-left">
          <div className="inline-flex items-center gap-2 bg-pink-50 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
            <Film className="w-5 h-5 text-violet-300" />
            <span className="text-violet-200 text-sm font-medium">Vidéo Pub IA</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4" style={{ fontFamily: 'Dancing Script, cursive' }}>
          ...
          <p className="text-violet-200 text-lg max-w-xl">
            Commandez des vidéos publicitaires uniques avec l&apos;intelligence artificielle PinkGirl
          </p>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="bg-pink-50 backdrop-blur-sm rounded-2xl p-6 text-center">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
            selectedCategory === 'all'
              ...
              : 'bg-pink-50 text-gray-300 hover:bg-white/20'
          }`}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredTemplates.map(template => (
          <div
            ...
            className="group bg-pink-50/50 border border-pink-100 rounded-2xl overflow-hidden cursor-pointer hover:border-violet-500/50 transition-all hover:scale-[1.02]"
          >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-pink-50/50 border border-pink-100 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-violet-500"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-pink-50/50 border border-pink-100 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-violet-500"
              >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-pink-50/50 border border-pink-100 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-violet-500 resize-none"
              />
            </div>
          </div>
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-violet-500/30 rounded-2xl p-8">
        ...
        <div className="mt-8 pt-6 border-t border-violet-500/30">
          ...
          <div className="bg-pink-50/50 rounded-lg p-3 mb-4 text-sm text-violet-200">
  ...
  const renderPaymentSuccess = () => (
    <div className="max-w-md mx-auto text-center py-12">
      ...
      <div className="flex flex-col gap-3">
        <button
          onClick={() => navigate('/dashboard/entreprise?tab=videos-pinkgirl')}
