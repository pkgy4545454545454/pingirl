...
const JobsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-24 pb-16">
      {/* Hero Section */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        {loading ? (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-sky-400">{job.enterprise_name}</p>
                  </div>
                </div>

                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-pink-500/20 text-pink-500 rounded-full text-xs font-medium">
          ...
          <div className="card-service rounded-xl p-12 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Aucune offre trouvée</h2>
