...
const InfluencerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] flex" data-testid="influencer-dashboard">
      {/* Sidebar */}
      <aside className="w-64 border-r border-white/5 bg-white flex flex-col">
        <div className="p-6 border-b border-white/5">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo_titelli.png" alt="PinkGirl" className="w-10 h-10 object-contain" />
            <span className="text-xl font-bold text-white" style={{ fontFamily: 'Dancing Script, cursive' }}>
              PinkGirl
            </span>
          </Link>
        </div>
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <button className="relative p-3 bg-pink-50/50 rounded-xl text-gray-400 hover:text-white transition-colors">
          ...
          <div className="space-y-6">
              ...
              <div className="card-service rounded-xl p-6 border-yellow-500/30">
                ...
                <div className="space-y-3">
                  {pendingCollabs.slice(0, 3).map((collab) => (
                    <div key={collab.id} className="p-4 bg-pink-50/50 rounded-xl">
            ...
            <div className="card-service rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-gradient-to-r from-white/5 to-white/10 rounded-xl border border-pink-100">
                  <div className="flex items-center gap-3 mb-3">
            ...
            <div className="card-service rounded-xl p-6">
              ...
              {friends.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {friends.map((friend) => (
                    <div key={friend.id} className="flex items-center justify-between p-4 bg-pink-50/50 rounded-xl">
                      <div className="flex items-center gap-3">
              ...
              <div className="space-y-4">
                {pendingCollabs.map((collab) => (
                  <div key={collab.id} className="card-service rounded-xl p-6">
                    ...
                    <div className="flex gap-3 mt-4 pt-4 border-t border-pink-100">
                      <button
                        onClick={() => handleRespondToCollab(collab.id, true)}
              ...
              {collaborations.filter(c => c.status === 'completed').length > 0 ? (
                <div className="space-y-3">
                  {collaborations.filter(c => c.status === 'completed').map((collab) => (
                    <div key={collab.id} className="p-4 bg-pink-50/50 rounded-xl flex items-center justify-between">
                      <div className="flex items-center gap-3">
        ...
        {activeSection === 'settings' && (
          <div className="max-w-2xl space-y-6">
            <div className="card-service rounded-xl p-6">
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between p-4 bg-pink-50/50 rounded-xl">
                  <div>
