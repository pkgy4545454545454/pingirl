        ...
        <div className="space-y-12 text-gray-400">
          ...
          <section className="bg-gray-800/30 rounded-2xl p-6 border border-gray-700">
            ...
            <div className="space-y-3 pl-2">
              <p><strong className="text-white">Raison sociale :</strong> PinkGirl SA</p>
              ...
              <p><strong className="text-white">Email :</strong> contact@pinkgirl.com</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="pl-2">
              Le directeur de la publication est le représentant légal de PinkGirl SA.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="pl-2 space-y-4">
              <p className="leading-relaxed">
                Le site PinkGirl utilise des cookies pour améliorer l'expérience utilisateur, analyser le trafic 
          ...
          <section>
            ...
            <div className="pl-2 space-y-4">
              <p className="leading-relaxed">
                L'ensemble des éléments constituant le site PinkGirl (textes, graphismes, logiciels, photographies, 
                images, sons, plans, logos, marques, etc.) sont la propriété exclusive de PinkGirl SA ou de ses partenaires.
              </p>
              <p className="leading-relaxed">
          ...
          <section className="bg-orange-900/20 rounded-2xl p-6 border border-orange-700/30">
            ...
            <p className="leading-relaxed">
              PinkGirl SA s'efforce d'assurer au mieux de ses possibilités l'exactitude et la mise à jour des informations 
              diffusées sur ce site. Toutefois, PinkGirl SA ne peut garantir l'exactitude, la précision ou l'exhaustivité 
          ...
          <section className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span>privacy@pinkgirl.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-yellow-400" />
              ...
              <div className="flex items-center gap-3">
                ...
                <span>PinkGirl SA - Lausanne, Suisse</span>
              </div>
            </div>
          </section>
        </div>
