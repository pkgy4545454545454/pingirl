...
const API_URL = process.env.REACT_APP_BACKEND_URL || 'https://pinkgirlv2back.onrender.com';
...
const CartPage = () => {
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-[#FFF5F9] pt-24 px-4" data-testid="cart-page">
        <div className="max-w-4xl mx-auto py-16 text-center">
          <div className="w-24 h-24 bg-pink-50/50 rounded-full flex items-center justify-center mx-auto mb-6">
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-24 px-4 pb-12" data-testid="cart-page">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div key={group.enterprise_id} className="card-service rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-pink-100">
                  ...
                  <Link 
                    ...
                    className="font-semibold text-white hover:text-pink-500 transition-colors"
                  >
                ...
                <div className="space-y-4">
                  {group.items.map((item) => (
                    <div key={item.id} className="flex gap-4 p-4 bg-pink-50/50 rounded-xl">
                      <div className="w-20 h-20 rounded-lg bg-pink-50 overflow-hidden flex-shrink-0">
                        {item.image ? (
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex items-center gap-2">
                            <button 
                              ...
                              className="w-8 h-8 rounded-full bg-pink-50 flex items-center justify-center text-gray-700 hover:bg-white/20 transition-colors"
                            >
            ...
            <div className="card-service rounded-xl p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2" style={{ fontFamily: 'Dancing Script, cursive' }}>
          ...
          <div className="lg:col-span-1">
            <div className="card-service rounded-xl p-6 sticky top-24">
              ...
              {/* Items summary */}
              <div className="space-y-2 mb-6 pb-6 border-b border-pink-100">
                {items.map((item) => (
              ...
              {/* Price Breakdown */}
              <div className="space-y-3 mb-6 pb-6 border-b border-pink-100">
              ...
              <div className="flex justify-between mb-6">
                ...
                <span className="text-2xl font-bold text-sky-400">{total.toFixed(2)} CHF</span>
              </div>
