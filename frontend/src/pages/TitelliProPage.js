/**
 * PinkGirl Pro++ Page - B2B Services
...
export default function PinkGirlProPage() {
  ...
  useEffect(() => {
    ...
    if (user.user_type !== 'enterprise' && user.user_type !== 'entreprise') {
      toast.error('PinkGirl Pro++ est réservé aux entreprises');
      navigate('/');
      return;
    }
  }, [user, navigate]);
    ...
    if (success && token) {
      ...
      (async () => {
        try {
          ...
          if (res.ok) {
            toast.success('PinkGirl Pro++ activé avec succès ! 🎉');
          } else {
  ...
  const handleSubscribe = async () => {
    try {
      ...
      if (data.checkout_url) {
        ...
        toast.success('Vous avez déjà PinkGirl Pro++ !');
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Proposez vos services dans les Lifestyle Passes PinkGirl'
    },
    {
      icon: Building2,
      title: 'Clients Entreprises',
      description: 'Accédez au réseau d\'entreprises partenaires PinkGirl'
    },
    {
      icon: BarChart3,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              PinkGirl <span className="text-amber-400">Pro++</span>
            </h1>
                  ...
                  <Card className="bg-zinc-800/50 border-zinc-700">
                    ...
                    <CardContent>
                      <p className="text-zinc-400 text-sm mb-4">
                        Vos services peuvent être proposés dans les Lifestyle Passes PinkGirl
                      </p>
