...
const CashbackPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9]" data-testid="cashback-page">
      {/* Hero Section */}
      <section className="relative py-16 sm:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-sky-400/10 rounded-full blur-3xl animate-pulse" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-sky-400/10 border border-sky-300/30 rounded-full mb-6">
              <Sparkles className="w-4 h-4 text-sky-400" />
              <span className="text-sky-400 text-sm font-medium">Programme de fidélité</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Dancing Script, cursive' }}>
              PinkGirl <span className="text-sky-400">Cashback</span>
            </h1>
          ...
          {isAuthenticated ? (
            ...
            <div className="max-w-md mx-auto bg-pink-50/50 border border-pink-100 rounded-2xl p-6">
              <div className="text-center">
                <Lock className="w-12 h-12 text-gray-500 mx-auto mb-4" />
                <p className="text-gray-400 mb-4">Connectez-vous pour voir votre solde cashback</p>
                <Link 
                  to="/auth"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-pink-500 text-white font-medium rounded-xl hover:bg-pink-500/80 transition-all"
                >
                  Se connecter
                  <ArrowRight className="w-4 h-4" />
                </Link>
      ...
      <section className="py-16 bg-pink-50/50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-12" style={{ fontFamily: 'Dancing Script, cursive' }}>
            Comment ça marche ?
          </h2>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-4" style={{ fontFamily: 'Dancing Script, cursive' }}>
            Niveaux de fidélité
          </h2>
            ...
            {tiers.map((tier, index) => (
              ...
              >
                <div className={`bg-gradient-to-br ${tier.color} p-6`}>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-gray-900 font-bold text-lg">{tier.name}</h3>
      ...
      {isAuthenticated && cashbackData.transactions.length > 0 && (
        <section className="py-16 bg-pink-50/50">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-3" style={{ fontFamily: 'Dancing Script, cursive' }}>
              <History className="w-6 h-6 text-sky-400" />
              Historique récent
            </h2>
            <div className="space-y-4">
              {cashbackData.transactions.slice(0, 5).map((tx, index) => (
                <div key={index} className="bg-pink-50/50 border border-pink-100 rounded-xl p-4 flex items-center justify-between">
                  <div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-pink-400/20 to-[#D4AF37]/20 border border-pink-100 rounded-2xl p-8 sm:p-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Dancing Script, cursive' }}>
              Prêt à commencer à économiser ?
            </h2>
            <p className="text-gray-400 mb-8 max-w-lg mx-auto">
              Rejoignez des milliers de clients qui économisent avec PinkGirl Cashback
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/products"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-pink-500 text-white font-semibold rounded-xl hover:bg-pink-500/80 transition-all"
              >
              ...
              <Link 
                to="/services"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-pink-50 text-white font-semibold rounded-xl hover:bg-white/20 transition-all"
              >
