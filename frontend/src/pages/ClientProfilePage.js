...
const ClientProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-20" data-testid="client-profile-page">
      {/* Header with Cover Image */}
      <div className="relative">
        {/* Cover Image */}
        <div className="h-48 md:h-64 bg-gradient-to-br from-pink-400/30 to-[#1a1a2e] overflow-hidden">
          {user.cover_image ? (
            <img 
        ...
        <div className="max-w-4xl mx-auto px-4 -mt-16 relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-end gap-4">
            {/* Avatar */}
            <div className="w-32 h-32 rounded-full border-4 border-[#050505] bg-pink-500 flex items-center justify-center text-white text-3xl font-bold overflow-hidden shadow-xl">
              {user.avatar ? (
                <img 
                  ...
                  {is_friend ? (
                    <>
                      <button
                        ...
                        className="px-6 py-2.5 bg-pink-500 text-white rounded-xl font-medium hover:bg-pink-500/80 transition-colors flex items-center gap-2"
                      >
                        <MessageSquare className="w-4 h-4" />
                        Message
                      </button>
                      <button className="px-4 py-2.5 bg-pink-50 text-white rounded-xl font-medium hover:bg-white/20 transition-colors flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 bg-pink-500 text-white rounded-xl font-medium hover:bg-pink-500/80 transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
                      {actionLoading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-pink-50 border border-pink-100 rounded-2xl p-6">
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <p className="text-2xl font-bold text-pink-500">{stats.mutual_friends}</p>
                ...
                <div className="space-y-3">
                  ...
                  {user.website && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 text-gray-300 hover:text-pink-500 transition-colors group"
                    >
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {feed_posts && feed_posts.length > 0 ? (
              <div className="space-y-4">
                {feed_posts.map((post) => (
                  <div key={post.id} className="bg-pink-50 border border-pink-100 rounded-2xl p-6">
                    {/* Post Header */}
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-full bg-pink-500 flex items-center justify-center text-white font-bold overflow-hidden">
                        {user.avatar ? (
                          <img 
                            src={user.avatar.startsWith('http') ? user.avatar : `${process.env.REACT_APP_BACKEND_URL}${user.avatar}`}
                            alt=""
              ...
              <div className="bg-pink-50 border border-pink-100 rounded-2xl p-12 text-center">
