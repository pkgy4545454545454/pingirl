      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
        <div className="bg-black/60 backdrop-blur-sm px-12 py-8 rounded-2xl text-center">
          ...
          <p className="text-gray-300 text-lg max-w-xl">
            Créez vos publicités professionnelles avec l'intelligence artificielle PinkGirl
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-200/80">
                Image HD <strong>sans filigrane</strong> disponible dans "Commandes PinkGirl"
              </p>
            </div>
          </div>
        </div>
  ...
  const renderConfirmStep = () => (
    <div className="max-w-md mx-auto text-center py-12">
      ...
      <p className="text-gray-400 mb-6">
        ...
        <span className="text-yellow-400 font-medium"> "Commandes PinkGirl"</span>
      </p>
      ...
      <div className="flex flex-col gap-3">
        <button
          onClick={() => navigate('/dashboard/entreprise?tab=commandes-pinkgirl')}
