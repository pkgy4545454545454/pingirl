...
const JobDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F9] pt-24" data-testid="job-detail-page">
      ...
      <div className="relative h-[35vh] min-h-[280px] overflow-hidden">
        ...
        <div className="relative h-full flex items-end">
          <div className="max-w-4xl mx-auto px-4 md:px-8 w-full pb-8">
            ...
            <p className="text-xl text-sky-400">{job.enterprise_name}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="card-service rounded-xl p-4 text-center">
                <Clock className="w-5 h-5 text-pink-500 mx-auto mb-2" />
          ...
          <div className="space-y-6">
            ...
            <div className="card-service rounded-xl p-4">
              ...
              <div className="flex justify-center gap-3">
                <button className="p-2 bg-pink-50 hover:bg-white/20 rounded-lg text-white transition-colors">
      ...
      {showApplyModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" data-testid="apply-modal">
          <div className="bg-white rounded-2xl w-full max-w-lg border border-pink-100 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-pink-50/50 rounded-xl p-4">
                ...
                <p className="text-sky-400 text-sm">{job.enterprise_name}</p>
              ...
              <div>
                ...
                {userDocuments.length > 0 ? (
                      ...
                      <label 
                        ...
                        className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors ${
                          applyForm.resume_url === doc.url 
                            ...
                            : 'bg-pink-50/50 border border-pink-100 hover:bg-pink-50'
                        }`}
                      >
                        <input
                          type="radio"
                  ...
                  <div className="text-center p-6 bg-pink-50/50 rounded-xl">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-pink-50/50 border border-pink-100 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:border-pink-400 outline-none h-32 resize-none"
                />
              </div>
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowApplyModal(false)}
                  className="flex-1 px-4 py-3 rounded-xl bg-pink-50 text-white hover:bg-white/20 transition-colors"
                >
                  Annuler
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-3 rounded-xl bg-pink-500 text-white hover:bg-pink-500/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {applying ? (
                    <>
